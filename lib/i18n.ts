...
export const translations: Translations = {
  ...
  specialistBusyMessage: {
    en: "This specialist is busy. You cannot contact them now.",
    uz: "Bu usta band. Unga bog'lana olmaysiz.",
    ru: "Этот специалист занят. Вы не можете с ним связаться.",
    kz: "Бұл маман бос емес. Сіз онымен байланыса алмайсыз.",
    kg: "Бул адис бош эмес. Сиз аны менен байланыша албайсыз.",
    kk: "Bul usta band. Onımen baylanısa almaısız.",
  },
  reviews: {
    en: "reviews",
    uz: "baxolar",
  ...
  noRatingsYet: {
    en: "This specialist has not been rated by clients yet",
    uz: "Bu usta mijozlar tomonidan hali baxolanmagan",
    ru: "Этот специалист еще не оценен клиентами",
    kz: "Бұл маман әлі клиенттер тарапынан бағаланбаған",
    kg: "Бул адис кардарлар тарабынан али баа берилген эмес",
    kk: "Bul usta mijozlar tárepinen áli baxalanbaǵan",
  },
  portfolio: {
    en: "Portfolio",
    uz: "Ishlar",
